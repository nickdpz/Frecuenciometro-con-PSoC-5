...
/* Qi */
#define Qi__0__INTTYPE CYREG_PICU2_INTTYPE7
#define Qi__0__MASK 0x80u
#define Qi__0__PC CYREG_PRT2_PC7
#define Qi__0__PORT 2u
#define Qi__0__SHIFT 7u
#define Qi__AG CYREG_PRT2_AG
#define Qi__AMUX CYREG_PRT2_AMUX
#define Qi__BIE CYREG_PRT2_BIE
#define Qi__BIT_MASK CYREG_PRT2_BIT_MASK
#define Qi__BYP CYREG_PRT2_BYP
#define Qi__CTL CYREG_PRT2_CTL
#define Qi__DM0 CYREG_PRT2_DM0
#define Qi__DM1 CYREG_PRT2_DM1
#define Qi__DM2 CYREG_PRT2_DM2
#define Qi__DR CYREG_PRT2_DR
#define Qi__INP_DIS CYREG_PRT2_INP_DIS
#define Qi__INTSTAT CYREG_PICU2_INTSTAT
#define Qi__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU2_BASE
#define Qi__LCD_COM_SEG CYREG_PRT2_LCD_COM_SEG
#define Qi__LCD_EN CYREG_PRT2_LCD_EN
#define Qi__MASK 0x80u
#define Qi__PORT 2u
#define Qi__PRT CYREG_PRT2_PRT
#define Qi__PRTDSI__CAPS_SEL CYREG_PRT2_CAPS_SEL
#define Qi__PRTDSI__DBL_SYNC_IN CYREG_PRT2_DBL_SYNC_IN
#define Qi__PRTDSI__OE_SEL0 CYREG_PRT2_OE_SEL0
#define Qi__PRTDSI__OE_SEL1 CYREG_PRT2_OE_SEL1
#define Qi__PRTDSI__OUT_SEL0 CYREG_PRT2_OUT_SEL0
#define Qi__PRTDSI__OUT_SEL1 CYREG_PRT2_OUT_SEL1
#define Qi__PRTDSI__SYNC_OUT CYREG_PRT2_SYNC_OUT
#define Qi__PS CYREG_PRT2_PS
#define Qi__SHIFT 7u
#define Qi__SLW CYREG_PRT2_SLW
#define Qi__SNAP CYREG_PICU2_SNAP
#define Qi_irq__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define Qi_irq__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define Qi_irq__INTC_MASK 0x40u
#define Qi_irq__INTC_NUMBER 6u
#define Qi_irq__INTC_PRIOR_NUM 7u
#define Qi_irq__INTC_PRIOR_REG CYREG_NVIC_PRI_6
#define Qi_irq__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define Qi_irq__INTC_SET_PD_REG CYREG_NVIC_SETPEND0

/* sw */
#define sw__0__INTTYPE CYREG_PICU3_INTTYPE0
#define sw__0__MASK 0x01u
#define sw__0__PC CYREG_PRT3_PC0
#define sw__0__PORT 3u
#define sw__0__SHIFT 0u
#define sw__1__INTTYPE CYREG_PICU3_INTTYPE1
#define sw__1__MASK 0x02u
#define sw__1__PC CYREG_PRT3_PC1
#define sw__1__PORT 3u
#define sw__1__SHIFT 1u
#define sw__2__INTTYPE CYREG_PICU3_INTTYPE2
#define sw__2__MASK 0x04u
#define sw__2__PC CYREG_PRT3_PC2
...
#define sw_irq__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define sw_irq__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define sw_irq__INTC_MASK 0x80u
#define sw_irq__INTC_NUMBER 7u
#define sw_irq__INTC_PRIOR_NUM 7u
#define sw_irq__INTC_PRIOR_REG CYREG_NVIC_PRI_7
#define sw_irq__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define sw_irq__INTC_SET_PD_REG CYREG_NVIC_SETPEND0
...
#define CY_PROJECT_NAME "Medidor_de_Frecuencia"
